<template>
    ...
    <app-layout>
        <template #breadcrumbs> /
            <Link href="/settings" class="underline">settings</Link> / <Link href="/settings/sessions" class="underline">sessions</Link>
        </template>

        <h6 class="mx-32">Other Browser Sessions</h6>
        <div class="mt-2 space-y-6" v-if="sessions.length > 0">
        ...
        <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
            ...
            <template #footer>
                ...
                <jet-button class="ml-3" @click="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }"
