        ...
        <div class="rounded-lg bg-ui-800 p-4 cursor-auto text-ui-300">
            <div v-if="page === 0">
                ...
                <div class="select-none flex flex-row space-x-4 max-w-xl">
                    <div @click="form.type = 0; stage[0] = true" class="flex flex-col border-2 border-ui-500 bg-ui-600 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-150 p-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-16 w-16" :class="stage[0] ? 'stroke-green-300' : 'stroke-ui-700'" fill="none"
                        ...
                        <p class="text-ui-400 text-sm">The simplest form of account linking. Allows third-party services
                    ...
                    <div class="select-none flex flex-col justify-center border-2 border-ui-500 bg-ui-700 rounded-lg p-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-16 w-16 stroke-ui-500" fill="none"
                             viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                  d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/>
                        </svg>
                        <span class="font-bold">Full Access <span class="text-red-500">(Unavailable)</span></span>
                        <p class="text-ui-400 text-sm">The highest level of account linking which both verifies ownership
            ...
            <div v-if="page === 1">
                ...
                <div class="flex flex-row space-x-4 max-w-xl">
                    <div @click="form.method = 0; stage[1] = true" class="select-none cursor-pointer flex flex-col border-2 border-ui-600 bg-ui-700 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-150 p-4">
                    ...
                    <div class="select-none cursor-pointer y items-center    justify-center border-2 border-ui-600 bg-ui-700 rounded-lg p-4">
                        ...
                        <span class="font-bold">GD Message</span>
            ...
            <div v-if="page !== 3" class="mt-4 flex flex-row justify-between">
                ...
                <button disabled v-else class="rounded text-ui-600 cursor-not-allowed bg-ui-700 py-1 px-2">&lt; Back</button>
                ...
                <template v-if="page === 2">
                    ...
                    <button disabled v-else class="rounded bg-ui-700 text-ui-400 py-1 px-2 shadow hover:shadow-md transition-shadow">Finish</button>
                </template>
                <template v-else>
                    <button v-if="stage[page]" @click="page++" class="rounded bg-ui-600 py-1 px-2 shadow hover:shadow-md transition-shadow">Next &gt;</button>
                    <button disabled v-else class="cursor-not-allowed rounded bg-ui-700 text-ui-400 py-1 px-2">Next &gt;</button>
                </template>
            </div>
        </div>
    </app-layout>
