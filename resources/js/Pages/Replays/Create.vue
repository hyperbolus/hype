            ...
            <div class="y space-y-2 pane w-full">
                ...
                <Label ref="dropzone">
                    ...
                    <div v-if="submission.file === null" class="y items-center rounded-md cursor-pointer bg-ui-950 border-2 border-dashed border-ui-700 p-2">
                        ...
                        <span class="text-ui-500">.gdr</span>
                    </div>
                ...
                <Label>
                    ...
                    <select v-model="submission.format" class="block bg-ui-950 text-sm border-0 rounded px-2 py-1 w-full">
                        <optgroup label="Preferred Formats">
                            <option value="gdr" selected>GD Replay</option>
                        ...
                        <optgroup label="DEPRECATED">
                            <option value="replaybot" disabled>ReplayBot</option>
                            <option value="replaybot_frame" disabled>ReplayBot Frame</option>
                            <option value="echo" disabled>Echo</option>
                            <option value="rush" disabled>Rush</option>
                            <option value="ur" disabled>Universal Replay</option>
                            <option value="ur_frame" disabled>Universal Replay Frame</option>
                            <option value="ddhor" disabled>DDHOR</option>
                            <option value="xbot" disabled>xBot</option>
                            <option value="xbot frame" disabled>xBot Frame</option>
                            <option value="ybot" disabled>yBot</option>
                            <option value="ybot frame" disabled>yBot Frame (Unsupported)</option>
                        </optgroup>
                    </select>
                </Label>

                <div class="x space-x-1 !mt-0.5 items-center text-amber-500 text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a.75.75 0 000 1.5h.253a.25.25 0 01.244.304l-.459 2.066A1.75 1.75 0 0010.747 15H11a.75.75 0 000-1.5h-.253a.25.25 0 01-.244-.304l.459-2.066A1.75 1.75 0 009.253 9H9z" clip-rule="evenodd" />
                    </svg>
                    <span>GD Replay will soon be the only allowed macro format!</span>
                </div>
