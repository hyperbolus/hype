    ...
    <app-layout title="Home">
        ...
        <div class="flex max-w-6xl w-full gap-4 py-4">
            <div class="flex flex-col space-y-4 w-3/4">
                    ...
                    <div class="flex space-x-4 items-center">
                        <div class="flex space-x-2 items-center">
                            <Dropdown align="left">
                                ...
                                <template #content>
                                    <div @click="setSortBy(0)" class="px-2 py-1 cursor-pointer hover:bg-neutral-100">ID</div>
                                    <div @click="setSortBy(1)" class="px-2 py-1 cursor-pointer hover:bg-neutral-100">Username</div>
                                    <div @click="setSortBy(2)" class="px-2 py-1 cursor-pointer hover:bg-neutral-100">Review Count</div>
                                </template>
                            </Dropdown>
                        </div>
                        <div class="flex space-x-2 items-center">
                ...
                <Link v-for="user in users" :href="route('users.show', user.id)" class="flex justify-between items-center rounded px-4 py-2 bg-gray-50 border border-gray-300 shadow hover:shadow-lg transition-shadow">
                    <h2>{{ user.name }}</h2>
