            ...
            <div class="y space-y-4 md:w-3/4">
                ...
                <form @submit.prevent="submit" class="y pane space-y-2">
                    ...
                    <label class="y">
                        ...
                        <textarea v-model="report.content" placeholder="Required" class="resize-none resize-y pane w-full placeholder-ui-600 border-none"></textarea>
                        <span class="x items-center text-ui-500 text-sm mt-1">
