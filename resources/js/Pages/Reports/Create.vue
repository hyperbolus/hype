    ...
    <app-layout title="New Report">
        ...
        <div class="x lg:max-w-5xl xl:max-w-6xl w-full gap-4 p-4">
            <div class="y space-y-4 md:w-3/4">
                ...
                <form @submit.prevent="submit" class="y pane space-y-2">
                    <label class="y">
                    ...
                    <label class="y">
                        ...
                        <textarea v-model="report.content" placeholder="Required" class="resize-none resize-y pane w-full placeholder-neutral-400 dark:placeholder-neutral-600 border-none"></textarea>
                        <span class="x items-center text-neutral-500 text-sm mt-1">
