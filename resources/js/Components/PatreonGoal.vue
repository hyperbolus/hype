...
<template>
    <div class="y text-sm rounded overflow-clip shadow">
        ...
        <div v-if="goal" class="px-2 transition-colors py-1 bg-white dark:bg-ui-900">
        ...
        <p class="px-2 py-1 transition-colors x bg-white dark:bg-ui-900" :class="{'text-red-500': !goal}">{{ goal.description }}</p>
    </div>
</template>
