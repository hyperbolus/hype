    ...
    <div @mouseout="open = false" @mouseenter="position(true)" ref="base" class="relative group">
        ...
        <div ref="shadow" class="z-100 absolute left-1/2 transition-[visibility] duration-0 " :class="open ? 'visible' : 'invisible'">
            <div class="absolute y items-center w-full pt-2 transition ease-out transform" :class="open ? ['opacity-100', 'duration-200', 'scale-100'] : ['duration-75', 'opacity-0', 'scale-95']">
                <template v-if="caret">
                    <div class="drop-shadow absolute border-[8px] border-t-0 top-0 border-transparent border-b-neutral-300 dark:border-b-neutral-700"></div>
                    <div class="z-10 absolute border-[8px] border-t-0 top-[1.5px] border-transparent border-b-neutral-100 dark:border-b-neutral-900"></div>
                </template>
                <div class="shadow-lg rounded bg-neutral-100 dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 rounded overflow-clip">
        ...
        <Teleport v-if="false" to="body">
            <div ref="tooltip" class="opacity-0 z-100 absolute top-0 left-0 transition-[visibility] duration-0 " :class="open ? 'visible' : 'invisible'">
                <div class="absolute y items-center w-full pt-2 transition ease-out transform" :class="open ? ['opacity-100', 'duration-200', 'scale-100'] : ['duration-75', 'opacity-0', 'scale-95']">
                    <div class="drop-shadow absolute border-[8px] border-t-0 top-0 border-transparent border-b-neutral-300 dark:border-b-neutral-700"></div>
                    <div class="z-10 absolute border-[8px] border-t-0 top-[1.5px] border-transparent border-b-neutral-100 dark:border-b-neutral-900"></div>
                    <div class="relative shadow-lg rounded bg-neutral-100 dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 rounded overflow-clip">
