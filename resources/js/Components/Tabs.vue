...
<template>
    <div class="y gap-2">
        <div class="text-center pane !px-1 !py-3 !rounded-lg select-none">
            <div class="x font-bold text-sm uppercase justify-around items-center relative">
                ...
                <div class="z-0 bg-neutral-900/60 absolute glider left-0 rounded-lg py-2 transition-transform ease-out duration-200" :style="`width: calc(100% / ${slots.length}); transform: translateX(calc(100% * ${currentTab}));`">&nbsp;</div>
            </div>
        </div>
