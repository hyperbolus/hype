...
<template>
    <div class="y items-center">
        <div v-if="editor && editable" class="x w-full flex-wrap border-b border-ui-700">
            <div class="flex flex-wrap items-center p-1 gap-1">
                <Dropdown>
                    <template #trigger>
                        <div class="px-2 py-0.5 rounded bg-ui-800">Paragraph v</div>
                    </template>
                    <template #content>
                        <div class="px-2">Paragraph</div>
                        <div class="px-2 text-2xl font-serif">Heading 1</div>
                        <div class="px-2 text-xl font-bold">Heading 2</div>
                        <div class="px-2 text-lg font-bold">Heading 3</div>
                        <div class="px-2" @click="editor.commands.toggleBlockquote()">Blockquote</div>
                    </template>
                </Dropdown>
                <Dropdown>
                    <template #trigger>
                        <div class="px-2 py-0.5 rounded bg-ui-800">List v</div>
                    </template>
                    <template #content>
                        <button title="Bullet Points" class="px-2 py-0.5 rounded" @click="editor.commands.toggleBulletList()" :class="{ 'bg-ui-700': editor.isActive('bulletList') }">
                        ...
                        <button title="Numbered List" class="px-2 py-0.5 rounded" @click="editor.commands.toggleOrderedList()" :class="{ 'bg-ui-700': editor.isActive('orderedList') }">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 my-1">
                ...
                <Dropdown>
                    <template #trigger>
                        <div class="px-2 py-0.5 rounded bg-ui-800">Insert v</div>
                    </template>
                    <template #content>
                        <div class="px-2" @click="editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()">Table</div>
                        <div class="px-2">Image</div>
                        <div class="px-2">Video</div>
                        <div class="px-2">Link</div>
                    </template>
                </Dropdown>

                <div class="py-3 border-x border-ui-700"></div>

                <button title="Bold" class="px-2 py-0.5 rounded" @click="editor.commands.toggleBold()" :class="{ 'bg-ui-700': editor.isActive('bold') }">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 my-1">
                ...
                <button title="Italics" class="px-2 py-0.5 rounded" @click="editor.commands.toggleItalic()" :class="{ 'bg-ui-700': editor.isActive('italic') }">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 my-1">
                ...
                <button title="Strikethrough" class="px-2 py-0.5 rounded" @click="editor.commands.toggleStrike()" :class="{ 'bg-ui-700': editor.isActive('strike') }">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 my-1">
                ...
                <button title="Underline" class="px-2 py-0.5 rounded" @click="editor.commands.toggleUnderline()" :class="{ 'bg-ui-700': editor.isActive('underline') }">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 my-1">
                ...
                <Icon title="Undo" @click="editor.commands.undo()" class="mx-2 my-1 w-5" size="24" type="outline" name="arrow-uturn-left"/>
                <Icon title="Redo" @click="editor.commands.redo()" class="mx-2 my-1 w-5" size="24" type="outline" name="arrow-uturn-right"/>
                <button title="View Source" class="px-2 py-0.5 rounded" @click="source = !source" :class="{ 'bg-ui-700': source }">
                    <Icon class="size-5 my-1" size="24" type="outline" name="code-bracket"/>
                </button>
                <button title="Whitespace" @click="editor.commands.toggleInvisibleCharacters()" class="px-2 py-0.5 rounded" :class="{ 'bg-ui-700': editor.storage.invisibleCharacters.visibility() }">
                    <Icon class="size-5 my-1" size="24" type="outline" name="backspace"/>
                </button>
