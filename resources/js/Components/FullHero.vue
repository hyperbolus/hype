<template>
    <div class="x h-64 justify-center w-full bg-cover bg-center" style="box-shadow: rgba(0, 0, 0, 0.85) 0 -75px 55px -25px inset;" :style="'background: red;'">
