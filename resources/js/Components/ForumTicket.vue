...
<template>
    <div class="x overflow-clip items-stretch items-center rounded-lg bg-opacity-60 bg-white dark:bg-ui-900 shadow transition hover:shadow-lg hover:bg-opacity-75 dark:hover:bg-opacity-75 gap-4 px-4">
        <div class="x space-x-4 grow">
            <div class="x items-center my-4">
                <div class="transition-colors bg-neutral-200 dark:bg-ui-800 p-3 rounded-full">
