...
<template>
    <div id="globalSearchBar" @focusin="handleFocus" class="x h-fit relative items-center rounded-lg transition-colors bg-neutral-300 dark:bg-ui-800">
        <input placeholder="Search Levels..." v-model="newQuery" type="text" class="pl-3 w-full truncate shrink text-sm py-1.5 border-none focus-visible:ring-0 bg-transparent dark:placeholder-ui-500"/>
