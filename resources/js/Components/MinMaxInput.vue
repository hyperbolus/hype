...
<template>
    <div class="y space-y-1 w-full">
        ...
        <div class="relative w-full pb-2">
            <input v-if="!disabled" class="w-full z-20 absolute h-1 bg-transparent pointer-events-none" v-model="a" @input="update" :step="step" :min="min" :max="max" type="range" :disabled="disabled"/>
            <input v-if="!disabled" class="w-full z-20 absolute h-1 bg-transparent pointer-events-none" v-model="b" @input="update" :step="step" :min="min" :max="max" type="range"  :disabled="disabled"/>
