    ...
    <div class="relative select-none cursor-pointer">
        ...
        <transition
            ...
            <div v-show="open" class="absolute z-50 rounded-md shadow-lg" :class="[widthClass, alignmentClasses, containerClasses]" style="display: none;" @click="open = false">
                <div class="dropdown rounded-md transition-colors overflow-clip bg-neutral-100 dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700" :class="contentClasses">
                    <slot name="content" />
                </div>
            </div>
        </transition>
